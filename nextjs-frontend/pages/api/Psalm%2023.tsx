...
const psalm23 = (req: NextApiRequest, res: NextApiResponse) => {
  res.status(200).json({
    query: "Psalm 23",
    canonical: "Psalm 23",
    parsed: [[19023001, 19023006]],
    passage_meta: [
      {
        canonical: "Psalm 23",
        chapter_start: [19023001, 19023006],
        chapter_end: [19023001, 19023006],
        prev_verse: 19022031,
        next_verse: 19024001,
        prev_chapter: [19022001, 19022031],
        next_chapter: [19024001, 19024010],
      },
    ],
    passages: [
