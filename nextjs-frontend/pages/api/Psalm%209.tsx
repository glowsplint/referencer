...
const psalm9 = (req: NextApiRequest, res: NextApiResponse) => {
  res.status(200).json({
    query: "Psalm 9",
    canonical: "Psalm 9",
    parsed: [[19009001, 19009020]],
    passage_meta: [
      {
        canonical: "Psalm 9",
        chapter_start: [19009001, 19009020],
        chapter_end: [19009001, 19009020],
        prev_verse: 19008009,
        next_verse: 19010001,
        prev_chapter: [19008001, 19008009],
        next_chapter: [19010001, 19010018],
      },
    ],
    passages: [
