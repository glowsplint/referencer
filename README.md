# Referencer [![react](https://badges.aleen42.com/src/react.svg)](https://badges.aleen42.com/src/react.svg) [![typescript](https://badges.aleen42.com/src/typescript.svg)](https://badges.aleen42.com/src/typescript.svg) [![Go](https://img.shields.io/badge/Go-1.21+-00ADD8?logo=go&logoColor=white)](https://go.dev/)
...
cd backend-go
go build ./cmd/server/
DATABASE_PATH=./data/referencer.db DEVELOPMENT_MODE=1 ./server
```
...
| `API_KEY` | (none) | ESV API authentication token |
