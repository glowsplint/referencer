...
test.describe("action console", () => {
  ...
  test("when an action is performed and console is opened, then log entries with details are shown", async ({
    page,
  }) => {
  ...
  test("when an action is undone, then its console entry appears with strikethrough", async ({
    page,
  }) => {
