...
describe("createMarkerElement", () => {
  it("creates a marker with an arrowhead polygon", () => {
  ...
  it("sets markerWidth and markerHeight from constants", () => {
...
describe("createArrowPath", () => {
  ...
  it("creates a path with stroke color and width", () => {
  ...
  it("applies stroke-dasharray when provided in style attrs", () => {
  ...
  it("does not set stroke-dasharray when null", () => {
  ...
  it("sets marker-mid when markerId is provided", () => {
    const path = createArrowPath("M 0 0 L 50 50", "#000", baseAttrs, {
  ...
  it("does not set marker-mid when markerId is not provided", () => {
    const path = createArrowPath("M 0 0 L 50 50", "#000", baseAttrs);
...
describe("createMarkerOnlyPath", () => {
  it("creates an invisible path that carries a marker-mid", () => {
...
describe("createHoverRingPath", () => {
  it("creates a hover ring with normal color and opacity", () => {
  ...
  it("uses red color and higher opacity for eraser mode", () => {
...
describe("createPreviewRect", () => {
  it("creates a group with a rect element", () => {
...
describe("createPreviewArrowPath", () => {
  it("creates a group with a dashed arrow path and marker", () => {
