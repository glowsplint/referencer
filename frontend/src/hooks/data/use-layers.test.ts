...
describe("useLayers", () => {
  ...
  it("updateLayerColor changes a layer's colour", () => {
    ...
    const id = result.current.layers[0].id;
    act(() => {
      result.current.updateLayerColor(id, "#000000");
    });
  ...
  it("updateLayerColor with non-existent id does nothing", () => {
    ...
    act(() => {
      result.current.updateLayerColor("non-existent", "#000000");
    });
  ...
  it("toggleLayerVisibility toggles a layer's visibility", () => {
    ...
    act(() => {
      result.current.toggleLayerVisibility(id);
    });
  ...
  it("toggleLayerVisibility with non-existent id does nothing", () => {
    ...
    act(() => {
      result.current.toggleLayerVisibility("non-existent");
    });
    expect(result.current.layers[0].visible).toBe(true);
  });
  ...
  it("updateLayerName changes a layer's name", () => {
    ...
    const id = result.current.layers[0].id;
    act(() => {
      result.current.updateLayerName(id, "Custom");
    });
  ...
  it("updateLayerName with non-existent id does nothing", () => {
    ...
    act(() => {
      result.current.updateLayerName("non-existent", "Nope");
    });
    expect(result.current.layers[0].name).toBe("Layer 1");
  });
  ...
  it("addHighlight adds a highlight to the specified layer", () => {
    ...
    const id = result.current.layers[0].id;
    act(() => {
      result.current.addHighlight(id, {
        editorIndex: 0,
        from: 1,
        to: 5,
        text: "hello",
  ...
  it("addHighlight to non-existent layer does nothing", () => {
    ...
    act(() => {
      result.current.addHighlight("non-existent", {
        editorIndex: 0,
        from: 1,
        to: 5,
        text: "hello",
  ...
  it("removeHighlight with non-existent highlight id does nothing", () => {
    ...
    act(() => {
      result.current.removeHighlight(layerId, "non-existent");
    });
    expect(result.current.layers[0].highlights).toHaveLength(1);
  });
  ...
  it("addLayer with extra colors does not duplicate preset colors", () => {
    ...
    act(() => {
      result.current.addLayer({ extraColors: [TAILWIND_300_COLORS[0]] });
    });
  ...
  it("addLayer returns id and name", () => {
    ...
    act(() => {
      ret = result.current.addLayer() as { id: string; name: string };
    });
  ...
  it("removeArrow removes an arrow by id", () => {
    ...
    act(() => {
      result.current.removeArrow(layerId, arrowId);
    });
  ...
  it("removeArrow with non-existent id does nothing", () => {
    ...
    act(() => {
      result.current.removeArrow(layerId, "non-existent");
    });
  ...
  it("clearLayerArrows removes all arrows from a layer", () => {
    ...
    act(() => {
      result.current.clearLayerArrows(layerId);
    });
  ...
  it("addHighlight returns the generated highlight id", () => {
    ...
    act(() => {
      returnedId = result.current.addHighlight(layerId, {
        editorIndex: 0,
        from: 1,
        to: 5,
        text: "hello",
  ...
  it("updateHighlightAnnotation updates annotation text", () => {
    ...
    act(() => {
      result.current.updateHighlightAnnotation(layerId, highlightId, "my note");
    });
  ...
  it("setActiveLayer does not clear annotations from other layers", () => {
    ...
    act(() => {
      result.current.addHighlight(secondId, {
        editorIndex: 0,
        from: 1,
        to: 5,
        text: "other",
  ...
  it("setActiveLayer to same layer does not clear blank annotations", () => {
    ...
    const id = result.current.layers[0].id;
    act(() => {
      result.current.setActiveLayer(id);
    });
  ...
  it("updateArrowStyle updates the style of an existing arrow", () => {
    ...
    act(() => {
      result.current.updateArrowStyle(layerId, arrowId, "dashed");
    });
  ...
  it("updateArrowStyle with non-existent arrow does nothing", () => {
    ...
    act(() => {
      result.current.updateArrowStyle(layerId, "non-existent", "dashed");
    });
  ...
  it("updateHighlightAnnotation with non-existent highlight does nothing", () => {
    ...
    act(() => {
      result.current.updateHighlightAnnotation(layerId, "non-existent", "note");
    });
