...
describe("usePositionMapping", () => {
  ...
  it("maps highlight positions through transaction mapping", () => {
    ...
    const layer = makeLayer({
      highlights: [
        { id: "h-1", editorIndex: 0, from: 10, to: 20, text: "hello", annotation: "", type: "highlight" },
      ],
    })
  ...
  it("maps underline positions through transaction mapping", () => {
    ...
    const layer = makeLayer({
      underlines: [
        { id: "u-1", editorIndex: 0, from: 10, to: 20, text: "hello" },
      ],
    })
  ...
  it("skips decorations on a different editor index", () => {
    ...
    const layer = makeLayer({
      highlights: [
        { id: "h-1", editorIndex: 1, from: 10, to: 20, text: "hello", annotation: "", type: "highlight" },
      ],
      underlines: [
        { id: "u-1", editorIndex: 1, from: 10, to: 20, text: "hello" },
      ],
    })
